...
# 추세를 따라가는 전략이라 신고가 근처 매수를 막지 않습니다. 100은 "52주 최고가를
# 넘어선 값이 아니면 산다"는 뜻입니다. 되돌리려면 95.0 으로 낮추세요.
MAX_NEAR_HIGH_PCT = 100.0
