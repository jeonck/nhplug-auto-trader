...
이 정도는 알아내야 해. 순서와 표현은 네가 정해:
  ...
  미국 주식도 할지
    → 한다고 하면, 미국장을 **언제** 볼지도 물어봐. 우리 시각으로 정규장은 밤
      22:30~새벽 5:00, 그 앞뒤로 프리마켓(오후 5시~밤 10:30)과 애프터마켓
      (새벽 5시~아침 9시)이 있어. 프리·애프터에도 주문은 들어가지만 사려는
      사람이 적어 원하는 값에 안 걸리고, 지표는 아직 어제 것이야. 이걸 쉬운 말로
      설명하고 고르게 해. 잘 모르겠다고 하면 정규장만 권해.
